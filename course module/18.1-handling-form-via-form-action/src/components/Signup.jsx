...
export default function Signup() {
    function signupAction(prevFormState,formData) {
        ...
        if (!isNotEmpty(password) || !hasMinLength(password,6)){
            errors.push('Please enter a valid password with 6 charecter');
        }
        ...
        if (acquisition.length === 0){
            errors.push('Acquisition at least one acquisition');
        }
        if (errors.length > 0){
            return {
                errors: errors,
    ...
    <form action={formAction}>
      ...
      <div className="control-row">
        <div className="control">
          ...
          <input type="text" id="first-name" name="first-name" defaultValue={formState.enteredValues?.fName}/>
        </div>

        <div className="control">
          <label htmlFor="last-name">Last Name</label>
          <input type="text" id="last-name" name="last-name" defaultValue={formState.enteredValues?.lName}/>
        </div>
      </div>
